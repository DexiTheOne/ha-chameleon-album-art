...
from custom_components.chameleon.const import CONF_RANDOMIZE_COLOR_ASSIGNMENT, DOMAIN
from custom_components.chameleon.switch import ChameleonRandomizeColorAssignmentSwitch
